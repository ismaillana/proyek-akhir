  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        <h1>Tabel Data Riwayat Pengajuan Verifikasi Ijazah</h1>
      </div>
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between w-100">
                    <h4>
                        Data Riwayat Pengajuan Verifikasi Ijazah
                    </h4>
                </div>
              </div>
              <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($verifikasiIjazah as $item)
                                ...
                                <tr>
                                    ...
                                    @role('bagian-akademik')
                                    <td class="text-center">
                                        <a href="{{ url('menu-admin/riwayat-pengajuan-verifikasi-ijazah-detail', $item->kode_verifikasi) }}"
