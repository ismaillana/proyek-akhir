  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        <h1>Tabel Data Riwayat Pengajuan Izin Penelitian</h1>
      </div>
            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between w-100">
                    <h4>
                        Data Riwayat  Pengajuan Izin Penelitian
                    </h4>
                </div>
              </div>
              <div class="card-body">
                <form id="myForm" class="forms-sample" enctype="multipart/form-data" 
                    action="{{route('export-izin-penelitian')}}" method="GET">
                    <div class="row align-items-center" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-2 col-sm-12"><label for="">&nbsp;</label>
