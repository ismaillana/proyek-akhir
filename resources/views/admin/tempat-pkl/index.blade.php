                        ...
                        @foreach ($tempatPKL as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @php
                                        $pengajuan = \App\Models\Pengajuan::where('tempat_pkl_id', $item->id)->exists();
                                    @endphp

                                    @if (!$pengajuan)
                                        <button value="{{ route('tempat-pkl.destroy', $item->id) }}"
