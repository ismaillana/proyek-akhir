...
@foreach ($dispensasi as $dispensasi)
  <div class="modal fade" tabindex="-1" role="dialog" id="edit{{$dispensasi->id}}">
    <div class="modal-dialog" role="document">
        <form id="myForm" class="forms-sample" enctype="multipart/form-data" action="{{route('update-status-dispensasi', $dispensasi->id)}}" method="POST">
            @csrf
                        ...
                        <div class="input-group">
                            <select class="form-control @error('status')is-invalid @enderror" id="status" name="status" >
                                ...
                                <option value="Selesai"
                                    {{ old('status', @$dispensasi->status) == 'Selesai' ? 'selected' : '' }}>
                                        Selesai</option>
                            </select>
