                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control @error('name')is-invalid @enderror"
                                        ...
                                        value="{{ old('name', @$koorPkl->user->name) }}" disabled readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="number" class="form-control @error('nomor_induk')is-invalid @enderror"
                                        ...
                                        value="{{ old('nomor_induk', @$koorPkl->user->nomor_induk) }}" disabled readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="email" class="form-control @error('email')is-invalid @enderror"
                                        ...
                                        value="{{ old('email', @$koorPkl->user->email) }}" disabled readonly>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('wa') is-invalid @enderror"
                                            ...
                                            value="{{ old('wa', Str::substr(@$koorPkl->user->wa, 2)) }}" disabled readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input class="dropify @error('image') is-invalid @enderror" 
                                        ...
                                        data-default-file="{{ @$koorPkl->image_url }}" disabled readonly>
                                </div>
                            </div>
                            </div>
                        </div>
